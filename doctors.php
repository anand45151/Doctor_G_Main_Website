...
$db = getDbInstance();
$select = array('Doctor_id', 'Doctor_Name', 'Doctor_Specialty', 'Doctor_Experiences', 'Doctor_Location', 'Doctor_Photo');

// Start building query according to input parameters.
// If search string
if ($search_string) {
    $db->where('Doctor_Name', '%' . $search_string . '%', 'like');
    $db->orwhere('Doctor_Specialty', '%' . $search_string . '%', 'like');
}
...
$rows = $db->arraybuilder()->paginate('doctors', $page, $select);
...
<div id="page-wrapper">
        ...
        <tbody>
            <?php foreach ($rows as $row): ?>
                <tr>
                    ...
                    <td><?php echo xss_clean($row['Doctor_Specialty']); ?></td>
                ...
                <div class="modal fade" id="confirm-delete-<?php echo $row['Doctor_id']; ?>" role="dialog">
                        ...
                        <form action="delete_doctor.php" method="POST">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <input type="hidden" name="del_id" id="del_id" value="<?php echo $row['Doctor_id']; ?>">
    ...
    <div class="text-center">
        <?php echo paginationLinks($page, $total_pages, 'doctors.php'); ?>
    </div>
    <!-- //Pagination -->
</div>
<!-- //Main container -->
